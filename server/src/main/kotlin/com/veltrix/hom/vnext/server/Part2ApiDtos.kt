...
@Serializable data class StoreItemResponse(val itemId:String,val itemType:String,val catalogVersion:String,val priceCoins:Long,val owned:Boolean,val available:Boolean,val requirements:String,val metadata:String)
