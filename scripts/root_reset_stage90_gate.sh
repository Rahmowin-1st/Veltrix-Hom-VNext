...
gradle --no-daemon \
  ...
  -Pandroid.testInstrumentationRunnerArguments.class=com.veltrix.hom.vnext.RootStage90InstrumentedTest \
...
for path in files:
    ...
    cases=[c for c in root.iter('testcase') if 'RootStage90InstrumentedTest' in c.attrib.get('classname','')]
