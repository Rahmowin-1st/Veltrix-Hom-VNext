...
cd "$ROOT"
mkdir -p out/regression out/foundation-regression docs
...
java -jar out/regression/core-regression.jar | tee docs/core-regression-output.txt
...
java -jar out/foundation-regression/foundation-regression.jar | tee docs/foundation-regression-output.txt
grep -q 'SUMMARY | PASS=48 FAIL=0 TOTAL=48' docs/core-regression-output.txt
grep -q 'SUMMARY | PASS=57 FAIL=0 TOTAL=57' docs/foundation-regression-output.txt
