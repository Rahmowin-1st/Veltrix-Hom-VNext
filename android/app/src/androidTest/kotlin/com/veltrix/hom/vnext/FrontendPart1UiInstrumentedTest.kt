...
class FrontendPart1UiInstrumentedTest {
    ...
    @Test fun personalExposesTrustworthySparseAndMapState(){
        ...
        compose.onNodeWithTag("personal-screen").assertIsDisplayed();compose.onNodeWithText("Alex").assertIsDisplayed();compose.onNodeWithText("Personal Map").assertIsDisplayed();compose.onNodeWithText("Locked").assertIsDisplayed()
    }
}
