...
class Part3FinalStateInstrumentedTest {
    @Test fun finalSnapshotsContextAndSemanticEventsSurviveRoomReopen()=runBlocking {
    ...
    @Test fun typedPart3RepositoryReachesRealHomePersonalWorkspaceCommandAndSearch()=runBlocking {
        val context=ApplicationProvider.getApplicationContext<Context>()
